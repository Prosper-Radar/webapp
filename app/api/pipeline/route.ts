  ...
  try {
    ...
    const rows = await db
      .select({
        ...
        parcelCode: parcels.parcelId,
        county: parcels.county,
        zoningCode: parcels.zoningCode,
        lotSizeSqft: parcels.lotSizeSqft,
        totalScore: dealScores.totalScore,
        tier: dealScores.tier,
        waterfrontScore: dealScores.waterfrontScore,
        zoningScore: dealScores.zoningScore,
        priceScore: dealScores.priceScore,
        lotSizeScore: dealScores.lotSizeScore,
        populationScore: dealScores.populationScore,
        trafficScore: dealScores.trafficScore,
        recencyScore: dealScores.recencyScore,
